...
with open('data/dict_comp.txt') as file:
    for line in file:
...
ax.set_title ("\n".join(wrap('Pic. 2. Comparing ratio of compression of lzw with dictionary', 60)), loc = 'center', size = 30)
